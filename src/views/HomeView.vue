  ...
  <n-config-provider :theme-overrides="themeOverrides">
    <n-space vertical>
      <n-layout>
          ...
          <n-row gutter="24">
            <n-col :span="5">
              <div align="center" class="logo">
                <n-icon-wrapper :size="70" :border-radius="50" color="{{colorData.color}}">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    viewBox="0 0 512 512">
                    <path d="M256 256s-48-96-126-96c-54.12 0-98 43-98 96s43.88 96 98 96c37.51 0 71-22.41 94-48"
                      fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="22">
                    </path>
            ...
            <n-col :span="15">
              <div align="center">
                <n-gradient-text gradient="linear-gradient(90deg, #1db3c8 0%,#1d1dc8 50%, #b31dc8 100%)">
        ...
        <n-layout has-sider>
          <n-layout-sider bordered show-trigger collapse-mode="width" :collapsed-width="64" :width="300"
            :native-scrollbar="false" :inverted="inverted" style="height:calc(100vh - 115px)">
            <n-menu :collapsed-width="64" :collapsed-icon-size="22" :options="menuOptions" default-value="about-me"
              watch-props="defaultValue" :default-expanded-keys="defaultExpandedKeys" />
          </n-layout-sider>
...
import {
  ...
  InfiniteOutline as InfiniteOutline,
  SchoolOutline as SchoolOutline,
  HeartOutline as HeartOutline,
  HardwareChipOutline as HardwareChipOutline,
  PulseOutline as PulseOutline,
  BluetoothOutline as BluetoothOutline,
  FolderOutline as FolderOutline,
  ShareSocialOutline as ShareSocialOutline,
  GameControllerOutline as GameControllerOutline,
  AppsOutline as AppsOutline,
  AnalyticsOutline as AnalyticsOutline,
...
const addNum = () => {
  ...
  if (value.value == 100) { flag = true }
  if (flag) { value.value = value.value - 1 }
  if (!flag) { value.value = value.value + 1 }
}
