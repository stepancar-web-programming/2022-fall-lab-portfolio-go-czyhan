        ...
        <n-tabs :bar-width="28" type="line" class="custom-tabs" trigger='hover'>
            <n-tab-pane name="Github" tab="Github">
                <n-card title="Github" hoverable>
                    ...
                    <n-avatar size="large" src="https://avatars.githubusercontent.com/u/72414103?v=4" />
                    ...
                    <n-tag :bordered="false" type="info" round>
                        ...
                        Followers:
                        <n-number-animation ref="numberAnimationInstRef" :from="0" :to="followers" />
                        · Following:
                        <n-number-animation ref="numberAnimationInstRef" :from="0" :to="following" />
                        <template #icon>
...
export default defineComponent({
    ...
    mounted() {
        axios.get("https://api.github.com/users/spbgzh").then(response => {
